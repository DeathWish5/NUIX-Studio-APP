...
using Saea.Networking.Utilities;
using System;
...
namespace Saea.Networking
{
    ...
    class Server
    {
        public string msg_received = "nothing now";
        ...
        private void ProcessReceive(SocketAsyncEventArgs e)
        {
            ...
            {
                msg_received = Encoding.ASCII.GetString(e.Buffer, e.Offset, e.BytesTransferred);
                msg_num += 1;
                //increment the count of the total bytes receive by the server
                Interlocked.Add(ref m_totalBytesRead, e.BytesTransferred);
                Console.WriteLine("The server has read a total of {0} bytes", m_totalBytesRead);
                Byte[] sendBuffer = Encoding.ASCII.GetBytes("what I received is " + msg_received);
        ...
        private void ProcessSend(SocketAsyncEventArgs e)
        {
            ...
            {
                string data_sent = Encoding.ASCII.GetString(e.Buffer, e.Offset, e.BytesTransferred);
